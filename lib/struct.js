...
class Struct {
    ...
    set(label,value){
        ...
        if ('array_type' in info && info.array_type) {
        ...
        if ('array_type' in info && info.array_type) {
            ...
            switch (type_state) {
                ...
                case FLOAT:
                    ...
                    break;
                case DOUBLE:
                    value = new Float64Array(section_data.buffer, section_data.byteOffset, section_data.length / Float32Array.BYTES_PER_ELEMENT);
                    break;
                case LONG:
